...
public class FssCreditLoanInfo implements Serializable{
	private static final long serialVersionUID = 7625071250969120871L;
	private List<FssCreditLoanProductVO> baseList;  //대출상품 리스트
	private List<FssCreditLoanOptionVO> optionList;  //대출상품 리스트
	public List<FssCreditLoanProductVO> getBaseList() {
		return baseList;
	}
	public void setBaseList(List<FssCreditLoanProductVO> baseList) {
		this.baseList = baseList;
	}
	public List<FssCreditLoanOptionVO> getOptionList() {
		return optionList;
	}
	public void setOptionList(List<FssCreditLoanOptionVO> optionList) {
