...
public class FssCreditLoanOptionVO implements Serializable {
	...
	private double crdt_grad_1;		//은행: 1~2 등급 [소수점 2자리] 비은행: 1~3 등급 [소수점 2자리]
	private double crdt_grad_4;		//은행: 3~4 등급 [소수점 2자리] 비은행: 4 등급 [소수점 2자리]
	private double crdt_grad_5;		//은행: 5~6 등급 [소수점 2자리] 비은행: 5 등급 [소수점 2자리]
	private double crdt_grad_6;		//은행: 7~8 등급 [소수점 2자리] 비은행: 6 등급 [소수점 2자리]
	private double crdt_grad_10;		//은행: 9~10 등급 [소수점 2자리] 비은행: 7~10 등급 [소수점 2자리]
