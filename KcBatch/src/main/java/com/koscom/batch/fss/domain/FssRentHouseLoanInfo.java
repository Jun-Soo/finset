...
public class FssRentHouseLoanInfo implements Serializable{
	private static final long serialVersionUID = 4988102515670305930L;
	private List<FssRentHouseLoanProductVO> baseList;  //대출상품 리스트
	private List<FssRentHouseLoanOptionVO> optionList;  //대출상품 리스트
	public List<FssRentHouseLoanProductVO> getBaseList() {
		return baseList;
	}
	public void setBaseList(List<FssRentHouseLoanProductVO> baseList) {
		this.baseList = baseList;
	}
	public List<FssRentHouseLoanOptionVO> getOptionList() {
		return optionList;
	}
	public void setOptionList(List<FssRentHouseLoanOptionVO> optionList) {
