package com.koscom.batch.person.domain;
...
public class PersonInfo implements Serializable {
	...
	protected   String  yn_push1; //일반push설정여부
	protected   String  yn_push2; //신용push설정여부
	protected   String  yn_push3; //부채push설정여부
	protected   String  yn_push4; //상품신청push설정여부
	protected   String  cd_push; //소리/진동 상태값
	...
	public String getYn_push1() {
		return yn_push1;
	}

	public void setYn_push1(String yn_push1) {
		this.yn_push1 = yn_push1;
	}
	...
	public String getYn_push4() {
		return yn_push4;
	}

	public void setYn_push4(String yn_push4) {
		this.yn_push4 = yn_push4;
	}
