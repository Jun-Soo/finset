...
public class FcmUtil {
	...
	public static boolean sendFcm(String sendTo, String title, String msg, String linkAddr, String os, String type) {
		...
		HttpPost 	post 	= new HttpPost("http://10.0.31.11:8102/fcm/send");
...
//	}
	...
	//추가 - 20180620 김휘경, 환경에 따라 다른 url을 던지기 위해
	@SuppressWarnings("unchecked")
	public static boolean sendFcmWithUrl(String fcmUrl, String sendTo, String title, String msg, String linkAddr, String os, String type) {
		
		logger.info("The fcmUrl is " + fcmUrl);
