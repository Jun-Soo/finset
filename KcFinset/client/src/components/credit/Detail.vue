<template>
	<section>
		...
		<div class="box-list list01">
			...
			<div class="item">
				<div class="top">
					<p class="symbol"><img src="../../assets/images/common/bu_busan.png" alt=""/>부산고려저축은행</p>
					<p class="text blue">대출연체(KCB) 정보등록</p>
				</div>
				<div class="text-wrap">
					<div class="left">
						<p class="key">조회일자</p>
