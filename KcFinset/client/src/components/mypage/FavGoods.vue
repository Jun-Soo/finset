  ...
  <section v-if="seen">
    ...
    <div class="box-list list01 noMG pb90">
      <div class="search">
        ...
        <div class="right">
          <multiselect class="multiselect-basic" :title="''" v-model="cd_goods_class" label="text" :show-labels="false" :options="options" :searchable="false" :allow-empty="false" @select="optingOnChange">
          </multiselect>
