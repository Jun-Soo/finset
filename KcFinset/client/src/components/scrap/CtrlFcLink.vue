      ...
      <div class="box-list list02 noMG" v-if="'bank'==this.curTab">
          <div class="item" v-for="bank in bankList" :key="bank.index">
              <div class="flex">
                  ...
                  <div class="btn" :class="{'on':bank.isClickMenu}" v-if="bank.yn_link==='Y'">
                      <button @click="clickMenu(bank.cd_fc)"></button>
                  ...
                  <div class="btn" :class="{'on':bank.isClickLink}" v-else><a href="#" @click="clickLink(bank.cd_fc)">연동하기</a>
                      <div class="menu">
                          <a href="#" @click="clickCert(bank)">공인인증서</a>
                          <a href="#" @click="clickId(bank)">아이디/비번</a>
                      </div>
      ...
      <div class="box-list list02 noMG" v-else-if="'card'==this.curTab">
          <div class="item" v-for="card in cardList" :key="card.index">
              <div class="flex">
                  ...
                  <div class="btn" :class="{'on':card.isClickMenu}" v-if="card.yn_link==='Y'">
                      <button @click="clickMenu(card.cd_fc)"></button>
                  ...
                  <div class="btn" :class="{'on':card.isClickLink}" v-else><a href="#" @click="clickLink(card.cd_fc)">연동하기</a>
                      <div class="menu">
                          <a href="#" @click="clickCert(card)">공인인증서</a>
                          <a href="#" @click="clickId(card)">아이디/비번</a>
                      </div>
      ...
      <div class="box-list list02 noMG" v-else-if="'etc'==this.curTab && etcList">
          <div class="item" v-for="etc in etcList" :key="etc.index">
              <div class="flex">
                  ...
                  <div class="btn" :class="{'on':etc.isClickMenu}" v-if="etc.yn_link==='Y'">
                      <button @click="clickMenu(etc.cd_fc)"></button>
                  ...
                  <div class="btn" :class="{'on':etc.isClickLink}" v-else><a href="#" @click="clickLink(etc.cd_fc)">연동하기</a>
                      <div class="menu">
                          <a href="#" @click="clickCert(etc)">공인인증서</a>
                          <a href="#" @click="clickId(etc)">아이디/비번</a>
                      </div>
...
export default {
  ...
  methods: {
    ...
    clickCert: function(bank) {
      ...
      var nm_person = this.$store.state.user.nm_person;
