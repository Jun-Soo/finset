...
public class KbRealEstateVO extends Pagination implements Serializable{
	...
	public KbRealEstateVO() {
	}

	public KbRealEstateVO(String no_person, int seq_memo_info, String no_manage_info,
