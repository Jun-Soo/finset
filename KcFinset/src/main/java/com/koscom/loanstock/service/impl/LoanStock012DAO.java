...
@Repository("LoanStock012DAO")
public class LoanStock012DAO extends FulltextDAO {
    private static final Logger logger = LoggerFactory.getLogger(LoanStock012DAO.class);
    @Resource
	...
	public FulltextResultVO send(FulltextHeaderVO headerVO, String fulltext, boolean isTest) {
		headerVO.setRestURL("rms/finset/interresult");
		
		logger.debug("input fulltext : {}", fulltext);
		FulltextResultVO vo = super.send(headerVO, fulltext, isTest);
		
		/*
		String str = "S063증권사명                                5  160  여1 여신사명1                               상품코드1   상품명1                                 0기1  00.26        0.36        100000000       1000000000      1여2 여신사명2                               상품코드2   상품명2                                 0기2  00.26        0.36        100000000       1000000000      1여3 여신사명3                               상품코드3   상품명3                                 0기3  00.26        0.36        100000000       1000000000      1여4 여신사명4                               상품코드4   상품명4                                 0기4  00.26        0.36        100000000       1000000000      1여5 여신사명5                               상품코드5   상품명5                                 0기5  00.26        0.36        100000000       1000000000      1";
