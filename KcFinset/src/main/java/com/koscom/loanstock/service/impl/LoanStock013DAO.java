...
@Repository("LoanStock013DAO")
public class LoanStock013DAO extends FulltextDAO {
	private static final Logger logger = LoggerFactory.getLogger(LoanStock013DAO.class);
    @Resource
	...
	public FulltextResultVO send(FulltextHeaderVO headerVO, String fulltext , boolean isTest) {
    	headerVO.setRestURL("rms/finset/interresultdetail");
