 ...
 *  </pre>
*/
@Service("LoanStock013Service")
public class LoanStock013ServiceImpl extends FulltextService implements LoanStock013Service {
    @Resource(name = "LoanStock013DAO")
    private LoanStock013DAO loanStock013DAO;

	private static final Logger logger = LoggerFactory.getLogger(LoanStock013ServiceImpl.class);
	 ...
	 */	
	public String CreateFulltext(final LoanStock013InVO vo) throws FulltextException {
	 ...
	 * @exception 	FulltextException
	 */	
	public String CreateOutFulltext(final LoanStock013OutVO vo) throws FulltextException {
	 ...
	 * @exception 	FulltextException
	 */	
	public LoanStock013OutVO CreateOutVO(String fulltext) throws FulltextException {
		String outJson = CreateOutJson(title, fulltext, outFields, outGridFields);
		logger.debug("outJson : {}", outJson);
		
		Gson gson = new Gson();
		LoanStock013OutVO vo = gson.fromJson(outJson, LoanStock013OutVO.class);
	 ...
	 * @exception 	FulltextException
	 */	
	public FulltextResultVO Send(final LoanStock013InVO vo) throws FulltextException {
		...
		FulltextResultVO resultVO = loanStock013DAO.send(headerVO, fulltext);
		return resultVO;
	}
