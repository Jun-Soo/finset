...
//			logger.info("cd_result : {},  message : {}", modifyPwdFailCntReturnClass.getCd_result(), modifyPwdFailCntReturnClass.getMessage());
	        ...
	        List<PersonShareInfo> listPersonShareInfoReqUpdate = personManager.listPersonShareInfoReqUpdate(personShareInfo);

	        //푸시발송
	        for(PersonShareInfo updateItem : listPersonShareInfoReqUpdate) {
