...
public class ScrReqBankVO implements Serializable{
	private static final long serialVersionUID = 5627819698350032327L;
	String no_person = "";			//회원관리번호
	long   seq_scraping_result = 0;	//스크래핑 일련번호
	String cd_fc = "";				//금융사코드
	String cd_account = "";			//계좌구분
	String no_account = "";			//계좌번호
