/*
 * VITCOM  SYSTEM MANAGEMENT  KHK  20180724~0809
 * 소비지출 관리 데이터
 * 
 * 수정
 * VITCOM  SYSTEM MANAGEMENT  KHK  20180822~23
 * 업종명 명칭변경
 * DB변경에 따라 전면적으로 변경
 */
...
public class ConsumeDataVO implements Serializable{
	...
	public ConsumeDataVO() {
	}
	public ConsumeDataVO(String no_person, int seq_consume, String type_in_out,
			...
			int seq_tran, String id_frt, Date dt_frt, String id_lst,
			Date dt_lst) {
