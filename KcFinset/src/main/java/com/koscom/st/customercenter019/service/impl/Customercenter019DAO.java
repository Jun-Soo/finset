...
@Repository("Customercenter019DAO")
public class Customercenter019DAO extends FulltextDAO {
	private static final Logger logger = LoggerFactory.getLogger(Customercenter019DAO.class);
    @Resource
	...
	public FulltextResultVO send(FulltextHeaderVO headerVO, String fulltext , boolean isTest) {
    	headerVO.setRestURL("rms/finset/mypagecovering");
    	
    	logger.debug("input fulltext : {}", fulltext);
    	FulltextResultVO vo = super.send(headerVO, fulltext, isTest);
		
		String str = "상품명                                  여신사명                                증권사명                                00등록일  상품개  상품만  기간 00.31        1.31        2.31        3.31        4.31        5.31        10000           한 01000000         10000000        00.6         10000           10000000        10  10  10  ";
