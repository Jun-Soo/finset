...
@Repository("Debt018DAO")
public class Debt018DAO extends FulltextDAO {
	private static final Logger logger = LoggerFactory.getLogger(Debt018DAO.class);
    @Resource
	...
	public FulltextResultVO send(FulltextHeaderVO headerVO, String fulltext , boolean isTest) {
    	headerVO.setRestURL("rms/finset/mypagecoveringdetail");
