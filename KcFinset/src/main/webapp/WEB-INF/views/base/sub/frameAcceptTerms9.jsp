...
<div id="wrapper" class="pop-full">
	...
	<div>
		<ul class="nav nav-outline nav-justified tabs affix-fixed">
			<li class="active"><a href="#tab1" data-target="#tab1" data-toggle="tab">SKT</a></li>
			...
			<div class="terms-body">			
				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="tab2">
						...
						<ol>
							...
							<li>회사는 다음 각 호에 해당하는 경우 서비스의 전부 또는 일부를 중지할 수 있습니다. 회사는 회사의 고의 또는 과실이 없는 한 이로 인하여 발생한 손해에 대하여 배상책임이 없습니다.
								<ol>
									...
									<li>회원이 회사의 본 서비스 운영을 방해하는 경우</li>
						...
						<p>회사는 관련법령이 정하는 바에 따라서 이용자의 개인정보를 보호하기 위하여 노력하며, 이용자의 개인정보에 관한 사항은 관련 법령 및 회사가 정하는 개인정보처리방침에 정한 바에 따릅니다.</p>  
						<h2>제12조 (개인정보의 처리)</h2>  
						<ol>
