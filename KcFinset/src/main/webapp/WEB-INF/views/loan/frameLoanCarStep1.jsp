...
// 		frmloanApplyStep.ssn_person.value = frmloanApplyStep.ssn1.value + frmloanApplyStep.ssn2.value;
		frmloanApplyStep.action = "<c:url value='/m/loan/frameLoanCarStep2.crz'/>";
	...
	<section id="content">
		...
		<div class="container">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="cd_car_maker_comp" maxlength="10" validate="required; label:제조사;" autocomplete="off"/>
			</div>
			<div class="form-group">
				<label class="control-label">차량모델명</label>
				<input type="text" class="form-control" name="cd_car_model" maxlength="10" validate="required; label:차량모델명;" autocomplete="off"/>
			</div>
			<div class="form-group">
				<label class="control-label">세부모델명</label>
				<input type="text" class="form-control" name="cd_car_model2" maxlength="10" validate="required; label:세부모델명;" autocomplete="off"/>
			</div>
			<div class="form-group">
				<label class="control-label">구입일자</label>
				<input type="tel" class="form-control" name="dt_car_purchase" maxlength="8" placeholder="숫자만 입력하세요" validate="required; label:구입일자;numeric" autocomplete="off"/>
			</div>
			<div class="form-group">
				<label class="control-label">차량번호</label>
				<input type="text" class="form-control" name="car_no" maxlength="9" validate="required; label:차량번호" autocomplete="off"/>
			</div>
			<div class="form-group">
