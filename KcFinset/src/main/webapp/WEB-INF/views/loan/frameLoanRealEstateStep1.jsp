...
// 		frmloanApplyStep.ssn_person.value = frmloanApplyStep.ssn1.value + frmloanApplyStep.ssn2.value;
		frmloanApplyStep.action = "<c:url value='/m/loan/frameLoanRealEstateStep2.crz'/>";
...
<div id="wrapper">
	...
	<section id="content">
		...
		<div class="container">
			...
			<div class="form-group">
				<label class="control-label">주소1</label>
				<input type="text" class="form-control" name="region_1" maxlength="10" validate="required; label:주소1;" autocomplete="off" placeholder="ex) 서울특별시, 경기도"/>
			</div>
			<div class="form-group">
				<label class="control-label">주소2</label>
				<input type="text" class="form-control" name="region_2" maxlength="10" validate="required; label:주소2;" autocomplete="off" placeholder="ex) 대치동, 서초동"/>
			</div>
			<div class="form-group">
				<label class="control-label">주소3</label>
				<input type="tel" class="form-control" name="region_3" maxlength="5" validate="required; label:번지;" autocomplete="off" placeholder="숫자만 입력해주세요."/>
			</div>
			<div class="form-group">
				<label class="control-label">동</label>
				<input type="tel" class="form-control" name="building_no" maxlength="5" placeholder="숫자만 입력하세요" validate="required; label:동;numeric" autocomplete="off" placeholder="숫자만 입력해주세요."/>
			</div>
			<div class="form-group">
				<label class="control-label">호수</label>
				<input type="text" class="form-control" name="room_no" maxlength="5" validate="required; label:호수" autocomplete="off" placeholder="숫자만 입력해주세요."/>
			</div>
			<div class="form-group">
				<label class="control-label">소득정보</label>
				<select class="selectpicker" name="income_info" validate="required;select-one;label:소득정보">
					<option value=''>소득정보</option>
