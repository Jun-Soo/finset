...
<script type="text/javascript">
	...
	function loanApplyStepStep() {
		...
		frmloanApplyStep.action = "<c:url value='/m/loan/frameLoanWorkerStep2.crz'/>";
	...
	<section id="content">
		...
		<div class="container">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="nm_comp" validate="required; label:직장명;restrictChars;" autocomplete="off"/>
			</div>
			
			<!--  <div class="form-group">
				<label for="" class="control-label">직/업종</label>
				<div class="input-group">						
					<input type="text" class="form-control" id="job" placeholder="직업종을 선택하세요" readonly="readonly"/>
