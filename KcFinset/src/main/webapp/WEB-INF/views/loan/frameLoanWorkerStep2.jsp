	...
	*/
	function frmSimpleDoc() {
		...
		if(userAgent == "iOS") {
			...
			window.Android.checkPasswordCert(result, noPerson, ssnPerson, bizLicence, hp, nhisStartRcptYm, nhisEndYm, ntsStartTaxYm, ntsEndTaxYm, ntsStartRcptYm, ntsEndRcptYm, ntsStartIncomeY, ntsEndIncomeY, finYear);
		}
	}
	...
	*/
	function frmStepNext() {
		if(frmloanApplyStep.status_change.value == '') {
			...
			frmloanApplyStep.action = "<c:url value='/m/loan/frameLoanWorkerStep3.crz'/>";
