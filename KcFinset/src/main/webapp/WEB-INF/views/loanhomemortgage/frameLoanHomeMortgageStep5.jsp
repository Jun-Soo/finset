...
<body class="bg_white">
<form name="frmTermsStep" id="frmTermsStep" action="<c:url value='/m/loanhomemortgage/frameLoanHomeMortgageStep6.crz'/>" method="post">
...
<div id="wrapper">
	...
	<section id="content">
        <div class="container">
			<div class="check-all">
				<div class="checkbox" id="dvCheckAll"><label for="checkall"><input type="checkbox" id="checkall"> 약관 전체 동의</label></div>
			</div>
		</div>
		<!-- panel -->
		<div class="panel-group agree-panel" id="termsList">
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="checkbox"> <label><input type="checkbox" name="checkbox1" id="checkbox1"
                                                         validate="checkbox-required:checkbox1;label:서비스 이용약관;" />
						<a href="" class="collapsed" role="button" data-toggle="collapse">서비스 이용약관</a></label></div>
				</div>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="checkbox"> <label><input type="checkbox" name="checkbox2" id="checkbox2"
                                                         validate="checkbox-required:checkbox2;label:휴대전화 본인인증 약관동의;"/>
						<a href="" class="collapsed" role="button" data-toggle="collapse">휴대전화 본인인증 약관</a></label></div>
				</div>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="checkbox"> <label><input type="checkbox" name="checkbox3" id="checkbox3"
                                                         validate="checkbox-required:checkbox3;label:신용정보 이용약관;"/>
						<a href="" class="collapsed" role="button" data-toggle="collapse">신용정보 이용약관</a></label></div>
				</div>
