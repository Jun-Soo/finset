            ...
            <div class="list-block">
                <div class="container-fluid prd-loan prd-affiliates" id="loan_product">
                    <a href="#url">
                        ...
                        <div class="list-info">
                            <dl class="loan-info" onclick="loanGoodsDetail('${List.cd_fc}','${List.cd_goods}');">
                                <dt>대출금리</dt>
                                <dd class="txt-point">
                        ...
                        <div class="loan-btn">
                            <%--<div class="checkbox ico-loan ico-choice">--%>
                                ...
                                <%--<label class="" for="s${List.cd_fc}${List.cd_goods}"></label> <!--  $(this).val() -->--%>
                            <%--</div>--%>
                            <div class="checkbox ico-loan ico-zzim">
                                <input type="checkbox" id="z${List.cd_fc}${List.cd_goods}" value="Y"
                                       onchange="loanGoodsChoice('${List.cd_fc}','${List.cd_goods}'
                                               , 'z${List.cd_fc}${List.cd_goods}', 'Y');" <c:out value="${List.yn_favorite eq 'Y' ? 'checked' : ''}"/> ><label class="" for="z${List.cd_fc}${List.cd_goods}"></label>
                            </div>
                        </div>
                    </a>
                </div>
