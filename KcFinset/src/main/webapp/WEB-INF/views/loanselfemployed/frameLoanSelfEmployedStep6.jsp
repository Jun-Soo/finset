...
<script type="text/javascript">
	...
	function loanApplyStepStep() {
		...
		frmloanApplyStep.action = "<c:url value='/m/loanselfemployed/frameLoanSelfEmployedStep7.crz'/>";
	...
	<section id="content">
		<div class="container">
			...
			<div class="form-block  form-input-block-confrim" >
				...
				<div class="form-group">
					<label class="sr-only">주민등록번호 앞 7자리</label>
					<div class="row">
						<div class="col-xs-5">
							<input type="text" value="${personVO.ssn_person }" class="form-control" name=""
