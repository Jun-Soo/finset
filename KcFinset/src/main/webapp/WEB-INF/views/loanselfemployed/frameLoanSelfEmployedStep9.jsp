...
<script type="text/javascript">
	...
	function jumpPage(){
		...
		$.ajax({
			url : "<c:url value='/m/loanselfemployed/listJobResult.crz'/>",
			data : data,
			async: true,
	...
	function nmCompInput(){
		frmloanApplyStep.action = "<c:url value='/m/loanselfemployed/frameLoanSelfEmployedStep10.crz'/>";
		frmloanApplyStep.submit();
	}
</script>
...
<div id="wrapper">
	...
	<div class="search-block affix-fixed">
		<div class="form-group has-feedback">	
			<label for="txt_detail" class="sr-only">직장명 검색</label>
	...
	<section id="content">
		...
		<div class="help-block" id="nmCompInput">
			<p>사업자명이 없을경우 직접입력 가능합니다.</p>
			<a role="button" class="btn btn-block btn-outline" onclick="nmCompInput();">사업자명 직접입력</a>
		</div>
