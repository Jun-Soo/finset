		...
		<div class="container">
			...
			<div class="form-block">
				...
				<div class="form-group">
					...
					<div class="row">
						<div class="col-xs-5">
							<input type="number" value="${personVO.ssn_person}" maxlength="8"  class="form-control" name="" placeholder="">
						</div>
						<div class="col-xs-1">
						...
						<div class="col-xs-6">
							...
							<input type="password" class="form-control xe_required" name="ssn2" id="ssn2" onclick="showSecureKeypad();" placeholder="주민번호뒷자리" maxlength="7"  autocomplete="off">
