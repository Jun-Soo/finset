...
public interface ApplyWebManager {
	 ...
	 * @return
	 */
	ReturnClass sendApply(ApplyVO applyVO) throws  IOException, FinsetException, FinsetMessageException;
	 ...
	 * @param prepareForm
	 */
	void agencyReturn(PrepareForm prepareForm) throws ParseException, IOException;
	 ...
	 * @return
	 */
	ReturnClass updateApplyChk(ApplyVO applyVO) throws Exception;
	...
	/**
	 * request param 을 targetUrl 로 전송한다.
	 * @param targetUrl
	 * @param param
	 * @return
	 */
	ReturnClass sendReqPOST(String targetUrl, String param) throws IOException;
