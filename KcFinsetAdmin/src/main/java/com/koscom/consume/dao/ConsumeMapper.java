/*
 * VITCOM  SYSTEM MANAGEMENT  KHK  20180724~0824
 * 소비 지출 - ConsumeMapper.xml을 호출하기 위한 인터페이스
 */
...
public interface ConsumeMapper {
	 ...
	 * @return
	 */
	List<StatsConsumeVO> listStatsConsumeInfo(ConsumeForm consumeForm);
	 ...
	 * @return
	 */
	List<StatsConsumeVO> listPeriodConsumeInfo(ConsumeForm consumeForm);
	
	/**
	 * 기간에 들어갈 꺾은선 그래프의 갯수를 알기 위해 분류 데이터 조회
	 * @param consumeForm
	 * @return
	 */
	List<String> listPeriodConsumeClassInfo(ConsumeForm consumeForm);
