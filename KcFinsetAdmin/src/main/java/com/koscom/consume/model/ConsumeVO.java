...
public class ConsumeVO implements Serializable{
	...
	private String 	means_consume;				// 소비수단항목 - 00:기타, 01:신용카드, 02:체크카드, 03:현금
	...
	private String yn_budget_except;			//예산제외여부

	public ConsumeVO() {
	}
	public ConsumeVO(String no_person, String type_in_out, String means_consume, String dt_trd, String tm_trd, String cd_class, String cd_type, String contents, String amt_in_out, String cd_fc, String no_approval, String mon_installment, String yn_pay_installment, String yn_cancel, String yn_auto, String id_frt, Date dt_frt, String id_lst, Date dt_lst) {
