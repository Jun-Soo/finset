...
public class ContentsVO  implements Serializable {
	...
	private String file_type; //파일종류(01-썸네일 / 02-본문)
	...
	private MultipartFile imgfiles1;	//썸네일 파일첨부
	private byte[] img_files1;
	private MultipartFile imgfiles2;	//본문 파일첨부
	private byte[] img_files2;
	private String seq_thum_file; //썸네일이미지 파일번호
	private String seq_body_file; //본문이미지 파일번호
