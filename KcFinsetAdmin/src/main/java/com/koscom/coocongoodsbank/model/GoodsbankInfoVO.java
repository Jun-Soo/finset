...
public class GoodsbankInfoVO implements Serializable {
	...
	private String cd_yn_send_docu;
	...
	public String getCd_yn_send_docu() {
		return cd_yn_send_docu;
	}
	public void setCd_yn_send_docu(String cd_yn_send_docu) {
		this.cd_yn_send_docu = cd_yn_send_docu;
	}
