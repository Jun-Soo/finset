...
public class FssRenthouseloanProductInfo implements Serializable{
	private static final long serialVersionUID = 8504464585038386492L;
	protected String dcls_month= "";		//공시 제출월 [YYYYMM]
	protected String fin_co_no= "";		//금융회사 코드
	protected String kor_co_nm= "";		//금융회사 명
	protected String fin_prdt_cd= "";		//금융상품 코드
