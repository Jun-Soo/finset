...
public class Kcb034Info implements Serializable{
	private static final long serialVersionUID = 1226158130417366109L;
	protected String seq_kcb_response= "";	//조회일련번호KCB_034_INFO
	protected String no_person= "";	//회원관리번호KCB_034_INFO
	protected String cnt_loan_before1= "";	//1개월전대출건수KCB_034_INFO
	protected String cnt_loan_before2= "";	//2개월전대출건수KCB_034_INFO
	protected String cnt_loan_before3= "";	//3개월전대출건수KCB_034_INFO
	protected String cnt_loan_before4= "";	//4개월전대출건수KCB_034_INFO
	protected String cnt_loan_before5= "";	//5개월전대출건수KCB_034_INFO
	protected String cnt_loan_before6= "";	//6개월전대출건수KCB_034_INFO
	protected String cnt_loan_before7= "";	//7개월전대출건수KCB_034_INFO
	protected String cnt_loan_before8= "";	//8개월전대출건수KCB_034_INFO
	protected String cnt_loan_before9= "";	//9개월전대출건수KCB_034_INFO
	protected String cnt_loan_before10= "";	//10개월전대출건수KCB_034_INFO
	protected String cnt_loan_before11= "";	//11개월전대출건수KCB_034_INFO
	protected String cnt_loan_before12= "";	//12개월전대출건수KCB_034_INFO
	protected String amt_loan_before1= "";	//1개월전대출금액KCB_034_INFO
	protected String amt_loan_before2= "";	//2개월전대출금액KCB_034_INFO
	protected String amt_loan_before3= "";	//3개월전대출금액KCB_034_INFO
	protected String amt_loan_before4= "";	//4개월전대출금액KCB_034_INFO
	protected String amt_loan_before5= "";	//5개월전대출금액KCB_034_INFO
	protected String amt_loan_before6= "";	//6개월전대출금액KCB_034_INFO
	protected String amt_loan_before7= "";	//7개월전대출금액KCB_034_INFO
	protected String amt_loan_before8= "";	//8개월전대출금액KCB_034_INFO
	protected String amt_loan_before9= "";	//9개월전대출금액KCB_034_INFO
	protected String amt_loan_before10= "";	//10개월전대출금액KCB_034_INFO
	protected String amt_loan_before11= "";	//11개월전대출금액KCB_034_INFO
	protected String amt_loan_before12= "";	//12개월전대출금액KCB_034_INFO
	protected String filler= "";	//FILLERKCB_034_INFO
	@Override
