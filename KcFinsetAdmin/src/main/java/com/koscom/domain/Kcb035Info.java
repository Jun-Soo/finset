...
public class Kcb035Info implements Serializable{
	private static final long serialVersionUID = -2528461845832689921L;
	protected String seq_kcb_response= "";	//조회일련번호KCB_035_INFO
	protected String no_person= "";	//회원관리번호KCB_035_INFO
	protected String cnt_delay_before1= "";	//1개월전연체건수KCB_035_INFO
	protected String cnt_delay_before2= "";	//2개월전연체건수KCB_035_INFO
	protected String cnt_delay_before3= "";	//3개월전연체건수KCB_035_INFO
	protected String cnt_delay_before4= "";	//4개월전연체건수KCB_035_INFO
	protected String cnt_delay_before5= "";	//5개월전연체건수KCB_035_INFO
	protected String cnt_delay_before6= "";	//6개월전연체건수KCB_035_INFO
	protected String cnt_delay_before7= "";	//7개월전연체건수KCB_035_INFO
	protected String cnt_delay_before8= "";	//8개월전연체건수KCB_035_INFO
	protected String cnt_delay_before9= "";	//9개월전연체건수KCB_035_INFO
	protected String cnt_delay_before10= "";	//10개월전연체건수KCB_035_INFO
	protected String cnt_delay_before11= "";	//11개월전연체건수KCB_035_INFO
	protected String cnt_delay_before12= "";	//12개월전연체건수KCB_035_INFO
	protected String amt_delay_before1= "";	//1개월전연체금액KCB_035_INFO
	protected String amt_delay_before2= "";	//2개월전연체금액KCB_035_INFO
	protected String amt_delay_before3= "";	//3개월전연체금액KCB_035_INFO
	protected String amt_delay_before4= "";	//4개월전연체금액KCB_035_INFO
	protected String amt_delay_before5= "";	//5개월전연체금액KCB_035_INFO
	protected String amt_delay_before6= "";	//6개월전연체금액KCB_035_INFO
	protected String amt_delay_before7= "";	//7개월전연체금액KCB_035_INFO
	protected String amt_delay_before8= "";	//8개월전연체금액KCB_035_INFO
	protected String amt_delay_before9= "";	//9개월전연체금액KCB_035_INFO
	protected String amt_delay_before10= "";	//10개월전연체금액KCB_035_INFO
	protected String amt_delay_before11= "";	//11개월전연체금액KCB_035_INFO
	protected String amt_delay_before12= "";	//12개월전연체금액KCB_035_INFO
	protected String cnt_longest_day_before1= "";	//1개월전최장연체일수KCB_035_INFO
	protected String cnt_longest_day_before2= "";	//2개월전최장연체일수KCB_035_INFO
	protected String cnt_longest_day_before3= "";	//3개월전최장연체일수KCB_035_INFO
	protected String cnt_longest_day_before4= "";	//4개월전최장연체일수KCB_035_INFO
	protected String cnt_longest_day_before5= "";	//5개월전최장연체일수KCB_035_INFO
	protected String cnt_longest_day_before6= "";	//6개월전최장연체일수KCB_035_INFO
	protected String cnt_longest_day_before7= "";	//7개월전최장연체일수KCB_035_INFO
	protected String cnt_longest_day_before8= "";	//8개월전최장연체일수KCB_035_INFO
	protected String cnt_longest_day_before9= "";	//9개월전최장연체일수KCB_035_INFO
	protected String cnt_longest_day_before10= "";	//10개월전최장연체일수KCB_035_INFO
	protected String cnt_longest_day_before11= "";	//11개월전최장연체일수KCB_035_INFO
	protected String cnt_longest_day_before12= "";	//12개월전최장연체일수KCB_035_INFO
	protected String filler= "";	//FILLERKCB_035_INFO
	@Override
