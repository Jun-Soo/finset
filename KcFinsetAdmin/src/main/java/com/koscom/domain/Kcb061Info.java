...
public class Kcb061Info implements Serializable{
	private static final long serialVersionUID = 4791803872915325539L;
	protected String seq_kcb_response= "";	//조회일련번호KCB_061_INFO
	protected String no_person= "";	//회원관리번호KCB_061_INFO
	protected String nm_biz_type= "";	//업종명KCB_061_INFO
	protected String nm_trade= "";	//거래기관명KCB_061_INFO
	protected String nm_agency= "";	//관리점명KCB_061_INFO
	protected String cd_type_deal= "";	//거래형태코드KCB_061_INFO
	protected String ymd_frt_delay= "";	//최초연체기산일자KCB_061_INFO
	protected String ymd_delay= "";	//연체기산일자KCB_061_INFO
	protected String amt_frt_delay= "";	//최초연체금액KCB_061_INFO
	protected String amt_delay= "";	//연체금액KCB_061_INFO
	protected String yn_mat_delay= "";	//만기후연체여부KCB_061_INFO
	protected String cd_profit_loss= "";	//기한이익상실코드KCB_061_INFO
	protected String amt_remain= "";	//대출잔액/미도래잔액KCB_061_INFO
	protected String ymd_repay= "";	//연체상환일자KCB_061_INFO
	protected String amt_repay= "";	//상환금액KCB_061_INFO
	protected String filler= "";	//FILLERKCB_061_INFO
	@Override
