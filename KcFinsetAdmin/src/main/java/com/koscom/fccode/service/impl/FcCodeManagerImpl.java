...
public class FcCodeManagerImpl implements FcCodeManager {
	...
	public FcEdocVO listFcEdocInfo(FcCodeForm fcCodeForm) {
		...
		List<FcEdocForm> fcEdocForm = fcCdMapper.listFcEdocInfo(fcCodeForm);
		
		FcEdocVO fcEdocVO = new FcEdocVO();
		fcEdocVO.setFcEdocForm(fcEdocForm);
		fcEdocVO.setMsgCount( fcEdocForm.size() );
		fcEdocVO.setMsgSize(fcEdocForm);
	...
	**/
	...
	public FcEdocVO listFcEdocRepeatInfo(FcCodeForm fcCodeForm) {
		// TODO Auto-generated method stub
		List<FcEdocForm> fcEdocForm = fcCdMapper.listFcEdocRepeatInfo(fcCodeForm);
