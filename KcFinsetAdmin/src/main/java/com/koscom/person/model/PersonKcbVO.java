...
import com.koscom.domain.PersonKcbInfo;
import com.koscom.env.model.CodeInfo;

public class PersonKcbVO extends PersonKcbInfo implements Serializable {

	private static final long serialVersionUID = -2434060076154749148L;
