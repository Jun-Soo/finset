...
public final class CodeUtil {
	 ...
	 * @throws Exception
	 */
	public String getNvlCodeName(String codeGroup, String codeValue, String nullValue) {

		if (codeGroup == null || StringUtil.isEmpty(codeGroup) || codeValue == null || StringUtil.isEmpty(codeValue)) {
			return nullValue;
		}
	...
	public String getCodeInfo(String codeGroup, String codeValue, String type) {
		...
		if (StringUtil.isEmpty(codeGroup) || StringUtil.isEmpty(codeValue)) {
			...
			if(StringUtil.isEmpty(sType)) sType="NM";
	 ...
	 * @throws Exception
	 */
	public CodeInfo getCodeInfo(String codeGroup, String codeValue) throws Exception{
	 ...
	 * @throws Exception
	 */
	public String getCodeEtc(String codeGroup, String codeValue) throws Exception {
