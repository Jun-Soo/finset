...
public class JSTLFunction {
	...
	public static String getNvlCodeName(String group, String id, String defaultStr){
		...
		try {
			codeManager = (CodeManager)getBean("codeManager");
			returnValue = codeManager.getCodeName(group, id);
		} catch (Exception e) {
			logger.debug("===========================");
...
//	}
	 ...
	 * @param type = 1:NM(Default) , 2:ID.NM ,3:ETC  
	 * @return
	 */
...
//	public static String makeGoodsOptions(String defaultText,String selectValue, String type) {
...
//	}
	 ...
	 * @return
	 */
	public static String makeOptionsEtc(String code_group, String defaultText, String selectName, String type) {
		CodeManager codeManager = (CodeManager)getBean("codeManager");
...
//	}
//	
	public static String makeRadioAndCheckBoxs(String code_group, String name, String type, String checkValues, int number, String event) {
...
//	}
	...
	public static String getProgram(String id_program, String type) {
	...
	public static String getApproval(String id_approval, String type) {
