...
<!-- 		<form name="frmGoodsDetails" id="frmGoodsDetails" enctype="multipart/form-data"> -->
			...
			<input type="hidden" name="chk_cd_live_type" id="chk_cd_live_type" value="">
			<input type="hidden" name="cd_live_type" id="cd_live_type" value="">
			<input type="hidden" name="chk_cd_house_type" id="chk_cd_house_type" value="">
			<input type="hidden" name="cd_house_type" id="cd_house_type" value="">
			<input type="hidden" name="chk_grade_nice" id="chk_grade_nice" value="">
			<input type="hidden" name="grade_nice" id="grade_nice" value="">
			
			<!--CFS주택담보 start  -->
			<div class="panel panel-primary">
				<div class="panel-heading">CFS자동차담보</div>		
...
<!-- 								<col width="20%"> -->
							...
							<tbody> 
								<tr>
									<th><input type="checkbox" name="chk_cd_sex" id="chk_cd_sex" value="Y" <c:out value="${goodsInfo.chk_cd_sex eq 'Y' ? 'checked' : ''}" />  /><label for="chk_cd_sex">성별</label></th>
									<td>
										${ufn:makeRadioAndCheckBoxs("cd_sex", "cd_sex", "checkbox", goodsInfo.cd_sex, 0)}
									</td>
								</tr>
...
<!-- 										</div> -->
								...
								<tr>
									<th><input type="checkbox" name="chk_cash_service" id="chk_cash_service" value="Y" <c:out value="${goodsInfo.chk_cash_service eq 'Y' ? 'checked' : ''}"  />/><label for="chk_cash_service">현금서비스</label></th>
									<td>
										<input type="text" class="form-control width-100" name="cnt_cash_service" value="${goodsInfo.cnt_cash_service}" maxlength="3" onkeypress="keyNumeric(event);"/>건 이하
										
										<input type="text" class="form-control width-100" name="amt_cash_service" value="${goodsInfo.amt_cash_service}" maxlength="6" onkeypress="keyNumeric(event);"/>만원 이하
									</td>
								</tr>
								...
								<tr>
									<th><input type="checkbox" name="chk_cd_owncar_type" id="chk_cd_owncar_type" value="Y" <c:out value="${goodsInfo.chk_cd_owncar_type eq 'Y' ? 'checked' : ''}" />/><label for="chk_cd_owncar_type">담보소유형태</label></th>
									<td>
										${ufn:makeRadioAndCheckBoxs("cd_owncar_type", "cd_owncar_type", "checkbox", goodsInfo.cd_owncar_type, 0)}
									</td>
								</tr>
								
								<tr>
									<th><input type="checkbox" name="chk_cd_car_type" id="chk_cd_car_type" value="Y" <c:out value="${goodsInfo.chk_cd_car_type eq 'Y' ? 'checked' : ''}" />/><label for="chk_cd_car_type">담보종류</label></th>
									<td>
										${ufn:makeRadioAndCheckBoxs("cd_car_type", "cd_car_type", "checkbox", goodsInfo.cd_car_type, 0)}
									</td>
								</tr>
								
								<tr>
									<th><input type="checkbox" name="chk_amt_carprice" id="chk_amt_carprice" value="Y" <c:out value="${goodsInfo.chk_amt_carprice eq 'Y' ? 'checked' : ''}" />/><label for="chk_amt_carprice">차량가격(만원)</label></th>
									<td>
										<input type="text" class="form-control width-100" name="amt_carprice_from" value="${goodsInfo.amt_carprice_from}" validate=" label:차량가격;" maxlength="6" onkeypress="keyNumeric(event);"/> ~
								
										<input type="text" class="form-control width-100" name="amt_carprice_to" value="${goodsInfo.amt_carprice_to}" validate=" label:차량가격;" maxlength="6" onkeypress="keyNumeric(event);"/>
									</td>
								</tr>
								
								<tr>
									<th><input type="checkbox" name="chk_no_caryear" id="chk_no_caryear" value="Y" <c:out value="${goodsInfo.chk_no_caryear eq 'Y' ? 'checked' : ''}" />/><label for="chk_no_caryear">차량연식(년)</label></th>
									<td>
										<input type="text" class="form-control width-100" name="no_caryear_from" value="${goodsInfo.no_caryear_from}" validate=" label:차량연식;" maxlength="6" onkeypress="keyNumeric(event);"/> ~
								
										<input type="text" class="form-control width-100" name="no_caryear_to" value="${goodsInfo.no_caryear_to}" validate=" label:차량연식;" maxlength="6" onkeypress="keyNumeric(event);"/>
									</td>
								</tr>
