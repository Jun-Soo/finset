...
<input type="hidden" id="s_value">
	<div class="panel-collapse toggle-cont">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">담보 상세항목</div>		
					...
					<table class="table table-classic">
							...
							<tbody> 
								...
								<tr>
									<th>주택종류</th>
									<td>
										${ufn:makeRadioAndCheckBoxs("cd_collateral_house_type", "cd_collateral_house_type", "checkbox", goodsbankInfo.cd_collateral_house_type, 0)}
									</td>
								</tr>
								...
								<tr>
									<th>자금용도</th>
									<td>
										${ufn:makeRadioAndCheckBoxs("cd_collateral_loan_use", "cd_collateral_loan_use", "checkbox", goodsbankInfo.cd_collateral_loan_use, 0)}
									</td>
								</tr>
								...
								<tr>
									<th>대출기간</th>
									<td>
										${ufn:makeRadioAndCheckBoxs("cd_term_loan", "cd_term_loan", "checkbox", goodsbankInfo.cd_term_loan, 0)}
									</td>
								</tr>
