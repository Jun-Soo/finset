...
<script type="text/javascript">
	...
	function jumpPage(page) {
		...
		vLoad("listPersonLoginHist","<c:url value='/person/listPersonLoginHist.crz'/>",data);
	}
</script>
</head>
<body>
...
<!-- 						</select> -->
						...
						<div class="input-daterange input-group date-w" id="datepicker">
						    ...
						    <input type="text" class="input-sm form-control" name="txt_dt_from" id="txt_dt_from" onclick="defaultSetting('sel_dt_kind', 'PH.dt_frt')" validate="date; lable:시작일자;" maxlength="8"/>
						    <span class="input-group-addon">~</span>
						    <input type="text" class="input-sm form-control" name="txt_dt_to" id="txt_dt_to" onclick="defaultSetting('sel_dt_kind', 'PH.dt_frt')" validate="date; lable:종료일자;" maxlength="8"/>
			   			</div>
						...
						<input type="text" id="txt_detail" name="txt_detail" class="form-control" onclick="defaultSetting('sel_detail','PI.nm_person')" validate="label:이름;keydown-enter:goSearch;" />
				...
				<div id="listPersonLoginHist">
					<%@ include file="/WEB-INF/views/person/listPersonLoginHist.jsp"%>
				</div>
			</form>
		</div>
	</div>
