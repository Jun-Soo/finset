...
<div class="panel panel-primary">
	<div class="panel-collapse">
		...
		<!-- List -->
		<table id="tbl_listCont" class="table table-bordered tbl-info" cellspacing="0" width="100%" oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
			<thead>
		         <tr>
		            <th>
					...
					<tr class="${class_string}">
		              ...
		              <td>
		              	<c:choose>
		              		...
		              		<c:otherwise>${ufn:formatMaskHpType("2", List.hp)}</c:otherwise>
		              	</c:choose>
