...
<!-- 			<h1 class="pull-left">금융사 전문관리</h1> -->
	...
	<!-- Content -->
		<div class="srch align-l">
			...
			<button type="button" class="btn btn-primary btn-xs" onclick="goCreateFssCompany();"><span class="glyphicon glyphicon-search" aria-hidden="true"></span>FSS금융감독원 금융회사</button>
			<button type="button" class="btn btn-primary btn-xs" onclick="goCreateFssMortgageLoan();"><span class="glyphicon glyphicon-search" aria-hidden="true"></span>FSS금융감독원 주택담보</button>
			<button type="button" class="btn btn-primary btn-xs" onclick="goCreateFssRentHouseLoan();"><span class="glyphicon glyphicon-search" aria-hidden="true"></span>FSS금융감독원 전세자금</button>
			<button type="button" class="btn btn-primary btn-xs" onclick="goCreateFssCreditLoan();"><span class="glyphicon glyphicon-search" aria-hidden="true"></span>FSS금융감독원 개인신용대출</button>
			</form>
		</div>
