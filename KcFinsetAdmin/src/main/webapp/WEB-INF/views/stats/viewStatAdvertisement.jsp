...
<script type="text/javascript">
	...
	function goSearch() {
		...
		vLoad("listStats","<c:url value='/stats/listStatAdvertisement.crz'/>",data);
	...
	function getExcel(){
		...
		frmStats.action = "<c:url value='/stats/listStatAdvertisementExcel.crz'/>";
...
<div class="ui-layout-center">
	<div class="ui-layout-content">
		...
		<form name="frmStats" id="frmStats" class="navbar-form">
			...
			<div id="listStats">
				<%@ include file="/WEB-INF/views/stats/listStatAdvertisement.jsp"%>
			</div>
		</form>
	</div>
</div>
