...
function goSearch() {
	...
	vLoad("listStats","<c:url value='/stats/listStatApplyComp.crz'/>",data);
...
function getExcel(){
	...
	frmStats.action = "<c:url value='/stats/listStatApplyCompExcel.crz'/>";
...
<%-- 					${ufn:quickYmdFromTo('T,Y,TM,W,LW,M,LM', 'txt_dt_from', 'txt_dt_to', '')} --%>
			...
			<div id="listStats">
				<%@ include file="/WEB-INF/views/stats/listStatApplyComp.jsp"%>
			</div>
		</form>
