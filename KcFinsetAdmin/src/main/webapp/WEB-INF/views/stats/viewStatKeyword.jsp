...
function goSearch() {
	...
	vLoad("listStats","<c:url value='/stats/listStatKeyword.crz'/>",data);
...
function getExcel(){
	...
	frmStats.action = "<c:url value='/stats/listStatKeywordExcel.crz'/>";
	...
	<form name="frmStats" id="frmStats" class="navbar-form">
		...
		<div class="srch">
				<div class="form-group" id="sandbox-container">
					...
					<select name="cd_advertisement_srch" class="selectpicker" id="cd_advertisement_srch" data-style="btn-primary">
						${ufn:makeOptions("cd_advertisement","광고매체", "")}
					</select>
					<select name="cd_keyword_comp" class="selectpicker" id="cd_keyword_comp" data-style="btn-primary">
						${ufn:makeOptions("cd_keyword_comp","광고처", "")}
					</select>
			...
			<div id="listStats">
				<%@ include file="/WEB-INF/views/stats/listStatKeyword.jsp"%>
			</div>
		</form>
