...
function goSearch() {
	...
	vLoad("listStats","<c:url value='/stats/listStatWorker.crz'/>",data);
...
function getExcel(){
	...
	frmStats.action = "<c:url value='/stats/listStatWorkerExcel.crz'/>";
